...
public class EthosChangeNotificationListPublisherTest {
    ...
    public void publisherThrowsExceptionTest() {
        assertThrows(IllegalArgumentException.class, () -> {
            new EthosChangeNotificationListPollService( null, 10 );
        });
    }
    ...
    public void subscribeThrowsExceptionTest() {
        assertThrows(IllegalArgumentException.class, () -> {
            EthosChangeNotificationListPollService publisher = new EthosChangeNotificationListPollService( mockEthosChangeNotificationService, 10 );
